        ...
        <article class="col-12 col-md-6 justify-content-center  mt-2">
            ...
            <div class="container">
                <form class="form-horizontal" role="form" action="/crearProforma/crearProforma" method="post">
                    ...
                    <legend class="col-form-label col-sm-2 pt-0">¿Necesita registrar al cliente?</legend>
                    <div class="col-sm-10 mb-3">
                        <div class="form-check">
                            <input class="form-check-input inputRegistrarCliente" type="radio" name="registroClienteRadios" id="registroClienteRadios1" value="si" >
                            <label class="form-check-label" for="registroClienteRadios1" >
                                si
                            </label>
                        </div>
                        <div class="form-check">
                            <input class="form-check-input inputIngresarCuit" type="radio" name="registroClienteRadios" id="registroClienteRadios2" value="no" checked>
                            <label class="form-check-label" for="registroClienteRadios2">
                                no
                            </label>
                        </div>
                    </div>
                    <div id="ingresarCuitCliente" class="collapse">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-12">
                            <input type="text" id="clienteTelefono" name="clienteTelefono" placeholder="Contraseña" class="form-control" >
                        </div>
                    </div>
                    <!--<div class="form-group">
