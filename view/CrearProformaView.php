            ...
            <div id="accordion">
                <div class="card ">
                    ...
                    <div id="collapseOne" class="collapse" aria-labelledby="headingOne" data-parent="#accordion">
                        ...
                        <form class="form-horizontal row" role="form" id="clienteRegistroFormulario"
                              action="/crearProforma/registrarCliente" method="post">
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteDenominacion" class="col-12 control-label"><span
                                            class="text-info">*</span>Denominacion</label>
                                <div class="col-12">
                                    <input type="text" id="clienteDenominacion" name="clienteDenominacion"
                                           placeholder="Denominacion" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteCuit" class="col-12 control-label"><span class="text-info">*</span>Cuit</label>
                                <div class="col-12">
                                    <input type="number" id="clienteCuit" name="clienteCuit" placeholder="CUIT"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <input type="text" id="clienteNombre" name="clienteNombre" placeholder="Nombre/s"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteApellido" class="col-12 control-label"><span
                                            class="text-info">*</span>Apellido</label>
                                <div class="col-12">
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteProvincia" class="col-12 control-label"><span
                                            class="text-info">*</span>Provincia</label>
                                <div class="col-12">
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteLocalidad" class="col-12 control-label"><span
                                            class="text-info">*</span>Localidad</label>
                                <div class="col-12">
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="clienteTelefono" class="col-12 control-label"><span
                                            class="text-info">*</span>Telefono</label>
                                <div class="col-12">
                                    <input type="text" id="clienteTelefono" name="clienteTelefono"
                                           placeholder="44662894" class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                            ...
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <input type="text" id="clienteContacto1" name="clienteContacto1"
                                           class="form-control">
                                </div>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                ...
                                <div class="col-12">
                                    <input type="text" id="clienteContacto2" name="clienteContacto2"
                                           class="form-control">
                                </div>
                            </div>
                            ...
                            <div class="container">
                                <button type="submit" class="btn btn-outline-primary btn-block mb-2">Registrar cliente
                                </button>
                ...
                <div class="card">
                    ...
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                        ...
                        <form class="form-horizontal row container m-auto" id="crearProformaFormulario" role="form"
                              action="/crearProforma/crearProforma" method="post">
                            <div class="col-12">
                                <h4 class="">Cliente</h4>
                            </div>
                            <div class="form-group col-12">
                                <label for="clienteRegistradoCuit" class="col-12 control-label"><span class="text-info">*</span>Cuit</label>
                                <input type="number" id="clienteRegistradoCuit" name="clienteRegistradoCuit"
                                       placeholder="CUIT" class="form-control">
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="cargaTipo" class="col-12 control-label"><span class="text-info">*</span>Tipo
                                    de carga</label>
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="cargaPeso" class="col-12 control-label"><span class="text-info">*</span>Peso
                                    en kilos</label>
                                <input type="number" id="cargaPeso" name="cargaPeso" placeholder=""
                                       class="form-control">
                            </div>
                            <div class="col-12">
                                <h4>Hazard</h4>
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input inputSiHazard" type="radio" name="hazardRadios"
                                           id="hazardRadios1" value="si">
                                    <label class="form-check-label" for="hazardRadios1">
                                        Si
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input inputNoHazard" type="radio" name="hazardRadios"
                                           id="hazardRadios2" value="no" checked>
                            ...
                            <div id="hazard" class="collapse form-group col-12">
                                <div class="form-group col-12">
                                    <label for="imoClass" class="col-12 control-label"><span class="text-info">*</span>IMO
                                        class</label>
                                    <select id="imoClass" name="imoClass" class="form-control col-12">
                                    </select>
                                </div>
                                <div class="form-group col-12">
                                    <label for="imoSubClass" class="col-12 control-label"><span
                                                class="text-info">*</span>IMO sub class</label>
                            ...
                            <div class="col-12 mb-3">
                                <div class="form-check">
                                    <input class="form-check-input inputSiReefer" type="radio" name="reeferRadios"
                                           id="reeferRadios1" value="si">
                                    <label class="form-check-label" for="reeferRadios1">
                                        Si
                                    </label>
                                </div>
                                <div class="form-check">
                                    <input class="form-check-input inputNoReefer" type="radio" name="reeferRadios"
                                           id="reeferRadios2" value="no" checked>
                            ...
                            <div class="form-group col-12 collapse" id="reefer">
                                <label for="reeferTemperatura" class="col-12 control-label"><span
                                            class="text-info">*</span>Temperatura C°</label>
                                <input type="number" id="reeferTemperatura" name="reeferTemperatura" placeholder=""
                                       class="form-control">
                            </div>
                            <div class="col-12">
                                <h4>Viaje</h4>
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="origenProvincia" class="col-12"><span
                                            class="text-info">*</span>Provincia</label>
                                <select id="origenProvincia" name="origenProvincia" class="form-control">
                                </select>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label for="origenLocalidad" class="col-12"><span
                                            class="text-info">*</span>Localidad</label>
                            ...
                            <div class="form-group col-12 col-md-6">
                                <label for="destinoProvincia" class="col-12"><span
                                            class="text-info">*</span>Provincia</label>
                                <select id="destinoProvincia" name="destinoProvincia" class="form-control">
                                </select>
                            </div>
                            <div class="form-group col-12 col-md-6">
                                <label for="destinoLocalidad" class="col-12"><span
                                            class="text-info">*</span>Localidad</label>
                            ...
                            <div class="form-group col-12">
                                <label for="fechaSalida" class="col-12 control-label"><span class="text-info">*</span>Fecha
                                    de salida</label>
                            ...
                            <div class="form-group col-12">
                                <label for="fechaLlegada" class="col-12 control-label"><span class="text-info">*</span>Fecha
                                    de llegada</label>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check text-center">
                                                    <input class="form-check-input" type="radio" name="vehiculoRadios"
                                                           id="vehiculoRadios{{patente}}" value="{{patente}}">
                                                    <label class="form-check-label"
                                                           for="vehiculoRadios{{patente}}"></label>
                                                </div>
                                            </td>
                                        </tr>
                                        {{/tablaVehiculos}}
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="mydatatableAcopladoProforma">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check text-center">
                                                    <input class="form-check-input" type="radio" name="acopladoRadios"
                                                           id="acopladoRadios{{patente}}" value="{{patente}}">
                                                    <label class="form-check-label"
                                                           for="acopladoRadios{{patente}}"></label>
                                                </div>
                                            </td>
                                        </tr>
                                        {{/tablaAcoplados}}
                                ...
                                <div class="table-responsive">
                                    <table class="table" id="mydatatableChoferProforma">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <div class="form-check text-center">
                                                    <input class="form-check-input" type="radio" name="choferRadios"
                                                           id="choferRadios{{id}}" value="{{id}}">
                    ...
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordion">
                        <div class="card-body">
                            <div class="row">
                                ...
                                <h5 class="col-12 col-md-6">Cliente CUIT: <span class="text-info"
                                                                                id="detalleProformaCliente"></span></h5>
                                <h5 class="col-12 col-md-6">Tipo carga: <span class="text-info"
                                                                              id="detalleProformaTipoCarga"></span></h5>
                                <h5 class="col-12 col-md-6">Peso carga: <span class="text-info"
                                                                              id="detalleProformaPesoCarga"></span></h5>
                                <h5 class="col-12 col-md-6">Datos hazard: <span class="text-info"
                                                                                id="detalleProformaDatosHazard"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Hazard: <span class="text-info"
                                                                          id="detalleProformaHazard"></span></h5>
                                <h5 class="col-12 col-md-6">Datos reefer: <span class="text-info"
                                                                                id="detalleProformaDatosReefer"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Reefer: <span class="text-info"
                                                                          id="detalleProformaReefer"></span></h5>
                                <h5 class="col-12 col-md-6">Viaje origen: <span class="text-info"
                                                                                id="detalleProformaViajeOrigen"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Viaje destino: <span class="text-info"
                                                                                 id="detalleProformaViajeDestino"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Cantidad kilometros: <span class="text-info"
                                                                                       id="detalleProformaCantidadKM"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Fecha salida: <span class="text-info"
                                                                                id="detalleProformaFechaSalida"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Fecha llegada: <span class="text-info"
                                                                                 id="detalleProformaFechaLlegada"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Patente vehiculo asignado: <span class="text-info"
                                                                                             id="detalleProformaVehiculoAsignado"></span>
                                </h5>
                                <h5 class="col-12 col-md-6">Patente acoplado asignado: <span class="text-info"
                                                                                             id="detalleProformaAcopladoAsignado"></span>
                                </h5>
                                <h4 class="col-12 col-md-6">Total: <span class="text-success" id="detalleProformaTotal">$0</span>
                                </h4>
                            </div>
